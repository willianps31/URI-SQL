...
VALUES
  ...
  select prod.name, prov.name from products as prod inner join providers as prov on prod.id_providers = prov.id inner join categories as c on c.id = prod.id_categories WHERE c.id = 6