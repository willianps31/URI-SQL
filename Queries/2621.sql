...
select prod.name from providers as prov inner join products as prod on prov.id = prod.id_providers where prod.amount>10 and prod.amount<20 and prov.name like 'P%'